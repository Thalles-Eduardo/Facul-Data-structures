...
public class ControledeAvioes {
    public static void main(String[] args) {
        ...
        while (opcao != 0) {
            ...
            System.out.println("3- Adicionar um avião � fila de espera.");
            System.out.println("4- Listar todos os aviões na fila de espera.");
            System.out.println("5- Listar as caracterésticas do primeiro avião da fila.");
            ...
            switch (opcao) {
                ...
                case 3:
                    ...
                    System.out.print("Digite o avião que deseja adicionar a lista: ");
                    ...
                    System.out.print("Adicione uma caracteréstica ao avião " + addElemento + ": ");
                ...
                case 5:
                    if(caracter.isEmpty()){
                        System.out.println("Não foi registrado nenhuma caracteréstica.");
                    }else{
                        System.out.println("Caracteréstica do primeiro avião da fila: " + caracter.firstElement());
                    }
                    break;
